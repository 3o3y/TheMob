# TheMob License (Source-Available)

Copyright (c) 2025 3o3y
...
- Reupload, redistribute, or share the compiled JAR of TheMob.
- Reupload, redistribute, or share modified versions of the compiled JAR.
...
Public forks must keep:
- This license
- Original credits
- A clear reference to the official repository

Forks may not be used to publish competing releases of TheMob.

## 4) Branding
You may not:
- Rebrand the plugin as your own work
- Claim authorship
...
## 6) Enforcement
Violation of these terms automatically terminates your rights to use, modify, or distribute the Software.
